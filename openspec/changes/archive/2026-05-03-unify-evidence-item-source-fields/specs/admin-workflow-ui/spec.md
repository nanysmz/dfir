...
#### Scenario: Evidence-item source editing avoids ambiguous duplicate fields
- **WHEN** an operator edits an evidence item in the main admin workflow
- **THEN** the form presents a unified source model instead of multiple
  apparently equivalent source-entry surfaces without clear hierarchy
